    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-500 text-sm">Start free — upgrade when you're ready to grow faster</p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="name" placeholder="Alex Creator" value={name} onChange={e => setName(e.target.value)} required />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-1">
                {["Basic SEO checklist", "5 keyword searches/day", "Basic analytics"].map(f => (
